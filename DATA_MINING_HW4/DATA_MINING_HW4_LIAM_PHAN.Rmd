...
Error_Rates_DF <- round(Error_Rates_DF,5)

DT::datatable(Error_Rates_DF, caption = "Error Rates from 3 Individual Method and 2 Ensembles Method") 

```

> Comments: The Smallest Error Rate is from the Average of Predicted Probabilities (Ensemble Method), while the biggest is from the Logistic Regression (Individual Method)
