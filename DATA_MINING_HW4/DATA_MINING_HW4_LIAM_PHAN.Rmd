...
### <span style="color: #1c6155;">Quick Preview</span>
...
### <span style="color: #1c6155;">Missing Variables Plot</span>
...
#### <span style="color: #1c6155;">Data Preprocessing</span>
...
> Comments: Our first decile is having a mean-response of 1.774. We can see that our first decile show us that our model is doing almost twice as better as a base random model. Then it quickly fall off from the 5th deciles and so on. 
...
> For the hierarchical clustering, we should normalize the dataset since we are dealing with euclidean distances in the process of clustering. 
