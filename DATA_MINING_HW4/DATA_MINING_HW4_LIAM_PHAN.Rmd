...
fviz_nbclust(, method = "silhouette") +
  labs(subtitle = "Silhouette method")

optimal_K1 <- 8

# Plotting
fviz_dend(hc1, rect = TRUE, cex = 0.5, k=optimal_K1)
...
# Optimal K for single linkage on Hierarchical Cluster
barplot(hc2$height,
  names.arg = (nrow(Cereals_Preprocess) - 1):1)

optimal_K2 <- 3

# Plotting
fviz_dend(hc2, rect = TRUE, cex = 0.5, k=optimal_K2)
